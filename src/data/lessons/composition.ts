...
export const composition: Track = {
  ...
  lessons: [
    ...
    {
      id: 'comp-camera',
      title: 'Where the camera goes',
      tagline: 'Composition is arrangement inside the frame. Choosing the frame itself is its own craft.',
      minutes: 8,
      level: 'building',
      blocks: [
        { kind: 'hero', demo: 'cp-shotsizes', caption: 'Shot size is a choice about intimacy: wide for context, close for feeling. Everything in this track applies at every shot size.' },
        { kind: 'demo', title: 'Camera height', demo: 'cp-angles', caption: 'Low angle makes a character powerful, high angle makes them small. It is that literal.' },
        {
          ...
          title: 'The handoff',
          items: [
            'Composition asks: where in the frame does everything sit?',
            'Cinematography asks: where is the camera, and why there?',
            'They are different decisions and you make the camera one first.',
            'The Cinematography track covers shot sizes, camera height, movement, framing rules and scene grammar in full.',
          ],
        },
      ],
    },
